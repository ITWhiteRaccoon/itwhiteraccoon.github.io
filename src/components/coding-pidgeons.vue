...
<style lang="scss" scoped>
	...
	.birds {
		...
		&__hatdove-body {
			...
			width         : 91px;
			height        : 110px;
			border-radius : 13px 0 0 40px / 70px 0px 0px 40px;
			background    : $birds-medium-light;
			...
			&:after {
				...
				width         : 0;
				height        : 0;
				border-bottom : 110px solid $birds-medium-light;
		...
		&__hatdove-backleg {
			...
			width        : 19px;
			border-style : solid;
			border-color : $birds-medium-dark transparent;
		...
		&__hatdove-frontleg {
			...
			width        : 19px;
			border-style : solid;
			border-color : $birds-medium-light transparent;
			border-width : 36px 12px 0;
		...
		&__hatdove-backwing {
			...
			&:after {
				...
				border-top       : 8px solid $birds-medium-light;
				border-right     : 13px solid $birds-medium-light;
		...
		&__hatdove &__circles-2 {
			...
			&:after {
				...
				height        : 170px;
				border-radius : 100%;
				border        : 8px solid $birds-dark;
				box-shadow    : inset 0 0 0 6px $birds-light, inset 0 0 0 14px $birds-dark;
			}
		}

		&__hatdove &__circles-1 {
			position         : absolute;
			top              : 135px;
			left             : 66px;
			width            : 58px;
			...
			&:after {
				...
				border-radius : 100%;
				border        : 8px solid $birds-dark;
				box-shadow    : inset 0 0 0 6px $birds-medium-light, inset 0 0 0 14px $birds-dark;
			}
		}

		&__hatdove-frontwing-finger {
			position         : absolute;
			top              : 174px;
			width            : 24px;
			height           : 30px;
			...
			transform-origin : right bottom;
			box-sizing       : border-box;
			border-top       : 8px solid $birds-light;
			border-right     : 13px solid $birds-light;
			animation        : hatdove-finger .6s infinite;
		}

		&__hatdove-frontwing-finger:nth-child(10) {
			left            : 44px;
			animation-delay : -.2s;
		}

		&__hatdove-frontwing-finger:nth-child(11) {
			left            : 56px;
			animation-delay : -.5s;
		}

		&__hatdove-frontwing-finger:nth-child(12) {
			left            : 68px;
			animation-delay : -.4s;
		}
		...
		&__rundove-body {
			...
			width         : 91px;
			height        : 110px;
			border-radius : 0 13px 40px 0px / 0px 70px 40px 0px;
			background    : $birds-medium-light;
		...
		&__rundove-backwing &__finger:nth-child(1) {
			position         : absolute;
			top              : -6px;
			left             : 40px;
			width            : 20px;
		...
		&__rundove-backwing &__finger:nth-child(2) {
			position         : absolute;
			top              : 40px;
			left             : 3px;
			width            : 20px;
		...
		&__rundove-backwing &__finger:nth-child(3) {
			position         : absolute;
			top              : 20px;
			left             : 20px;
			width            : 15px;
		...
		&__rundove-backwing &__circles {
			...
			&:after {
				...
				border-radius : 100%;
				border        : 8px solid $birds-dark;
				box-shadow    : 0 0 0 7px $birds-light, 0 0 0 60px $birds-dark;
			}
		}
		...
		&__rundove-frontwing &__finger:nth-child(1) {
			position         : absolute;
			top              : -6px;
			left             : 40px;
			width            : 20px;
		...
		&__rundove-frontwing &__finger:nth-child(2) {
			position         : absolute;
			top              : 40px;
			left             : 3px;
			width            : 20px;
		...
		&__rundove-frontwing &__finger:nth-child(3) {
			position         : absolute;
			top              : 28px;
			left             : 28px;
			width            : 20px;
		...
		&__table {
			...
			&:after {
				...
				width        : 14px;
				border-style : solid;
				border-color : $birds-bright transparent;
				border-width : 0 54px 30px;
			}
		}


		&__laptop:nth-child(3) {
			position      : absolute;
			top           : 265px;
			left          : 476px;
			height        : 7px;
		...
		&__feather:nth-child(6) {
			...
			&:before {
				...
				height        : 30px;
				border-radius : 100%;
				border        : 6px solid $birds-dark;
				box-shadow    : inset 0 0 0 4px $birds-medium-light;
				background    : $birds-dark;
			}
		}

		&__feather:nth-child(7) {
			position      : absolute;
			top           : 296px;
			left          : 234px;
			width         : 15px;
